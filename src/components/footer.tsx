...
export function Footer({settings,ready}:{settings:SiteSettings;ready:boolean}) {
  ...
  return <footer className="overflow-hidden border-t border-line bg-paper pt-20">
    <div className="shell grid gap-14 pb-16 lg:grid-cols-[1.1fr_1fr]">
      <div><Eyebrow>Stay in the LOOP</Eyebrow><h2 className="text-4xl tracking-[-.03em]">Good things are<br/><span className="text-clay">better shared.</span></h2><p className="mt-5 mb-7 max-w-sm text-sm leading-6 text-muted">Hear about community events, ways to help, and what’s happening at LOOP.</p><InquiryForm kind="newsletter" compact ready={ready}/></div>
    ...
    <div className="shell border-t border-line pt-8"><div aria-hidden className="footer-wordmark flex justify-between font-bold"><span>L</span><span className="text-clay">OO</span><span>P</span></div></div>
